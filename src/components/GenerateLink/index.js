...
function GenerateLink() {
  ...
  const URL = `https://azkaanti-wedding.zfachrian.com/?type=invitation&?to=${encodeURIComponent(name)}`;
            ...
            <table class="table">
              ...
              <tbody>
                {data.map((d, index) => {
                  ...
                  const mapURL = `https://azkaanti-wedding.zfachrian.com/?type=invitation&to=${encodeURIComponent(d.name)}${offlineInvitation}`;
                  return (
                    <tr>
                      <td>{index + 1}</td>
                      <td>{d.name}</td>
  ...
  return (
    <div>
      ...
      <h3 className="title__sub">Azka & Anti Wedding</h3>
